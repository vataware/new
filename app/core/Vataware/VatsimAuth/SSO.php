...
class SSO {
    ...
    public function signature($signature, $private_key=false){
        ...
        if ($signature=='RSA' || $signature=='RSA-SHA1'){
            ...
            $this->signature = new SSOSignatureMethodRSASHA1($private_key);
            ...
            $this->signature = new OAuth\SignatureMethodHMACSHA1;
    ...
    public function requestToken($return_url=false, $allow_sus=false, $allow_ina=false){
        ...
        $req = OAuth\Request::from_consumer_and_token($this->consumer, false, "POST", $tokenUrl, array(
    ...
    public function sendToVatsim(){
        ...
        return Redirect::to($this->base . $this->loc_login . $this->token->key);
    ...
    public function checkLogin($tokenKey, $tokenSecret, $tokenVerifier){
        ...
        $req = OAuth\Request::from_consumer_and_token($this->consumer, $this->token, "POST", $returnUrl, array(
